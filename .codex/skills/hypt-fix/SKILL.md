...
---
<!-- Generated from plugin/commands/fix.md. Do not edit by hand. Run `node scripts/sync-codex-support.mjs` instead. -->

# hypt-fix — Diagnose and Fix Bugs
...
Spawn 2-3 sub-agents **in parallel** (single message, multiple tool calls) to investigate the bug.
...
Launch 2-3 additional sub-agent runs to investigate edge cases and historical context:
