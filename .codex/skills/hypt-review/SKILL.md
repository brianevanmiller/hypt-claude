...
---
<!-- Generated from plugin/skills/review/SKILL.md. Do not edit by hand. Run `node scripts/sync-codex-support.mjs` instead. -->

# hypt-review — Thorough PR Review
...
Spawn parallel sub-agents to launch ALL FOUR agents in a SINGLE message (parallel execution). Each agent gets the full diff and PR context.
