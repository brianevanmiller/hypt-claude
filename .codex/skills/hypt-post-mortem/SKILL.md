...
---
<!-- Generated from plugin/skills/post-mortem/SKILL.md. Do not edit by hand. Run `node scripts/sync-codex-support.mjs` instead. -->
...
Start a new Codex session and run one of:
...
Read the current backlog, then add a new unchecked item under `## Bugs` that describes the issue found in the post-mortem. edit the file.
