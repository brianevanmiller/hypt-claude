...
Invoke the Skill tool with skill: "hypt:close"
...
After close completes, simply confirm:

```
YOLO complete. Shipped and merged.
```

The close skill already provides the detailed summary with PR, release, deployment links, etc. No need to repeat it.
