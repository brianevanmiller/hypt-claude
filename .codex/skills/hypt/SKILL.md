...
10a. `$hypt-post-mortem` — analyze what went wrong after a restore (runs automatically after $hypt-restore)
...
13. `$hypt-suggestions` — suggest next tasks, group related items, and offer $hypt-yolo or $hypt-go activation (runs automatically in close)
